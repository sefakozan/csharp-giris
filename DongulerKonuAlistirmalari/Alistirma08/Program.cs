...
namespace Alistirma08
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Alıştırma 8 : 0 ile 100 santigrat derece arasındaki derecelerin fahrenhayt karşılıklarını konsola");
            Console.WriteLine("santigrat(sekme) fahrenhayt(sekme) şeklinde alt alta yazdırınız.");
            int C;
            double F;
